...
public class DBUtil{
	...
	//声明数据库连接字符串
	private static String url="jdbc:mysql://localhost:3306/pd_test1";
	...
	private static String pass = "xiyongfeng";
	...
	public static Connection getConnection()//得到数据库连接的方法
	{
		try
		{
			...
			con=DriverManager.getConnection(url,name,pass);//得到连接
		}
